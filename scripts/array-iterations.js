...
// Complete the exercise in the space below:
 veryOldInventors = inventors.filter(function (deadPerson){
    if (deadPerson.year>= 1500 && deadPerson.year <=1599 ){
...
// Complete the exercise in the space below:
inventorNames = inventors.map(function(theDeceased){
    //if there is more than two things just use objects
    return {first: theDeceased.first, last: theDeceased.last}
})
...
// Complete the exercise in the space below:
const birth = inventors.sort((a,b) => a.year - b.year)
sortedByBirthYear.push(birth);
// Check your work:
...
// Complete the exercise in the space below:
inventorNamedAda = inventors.find(function (findPerson){
    return findPerson.first==="Ada"
})
// Check your work:
